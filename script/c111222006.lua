...
function s.initial_effect(c)
	--Fusion materials
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,s.mondstadtfilter,s.windfilter)

	--Add 1 "Genshin" monster from GY to hand
	...
	--Send this card to GY; Special Summon 2 "Genshin" monsters from Deck
	...
	--GY effect: Discard 1 "Genshin"; negate and revive
...
function s.mondstadtfilter(c,fc,sumtype,tp)
	return c:IsSetCard(0x1700)  -- "Mondstadt" monster (I set 0x701 as example)
end
